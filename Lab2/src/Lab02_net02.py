...
model.add(Dense(units=1000, activation='sigmoid',name='01_sigmoid'))
model.add(Dense(units=500, activation='tanh',name='02_tanh'))
model.add(Dense(units=300, activation='relu',name='03_relu'))
model.add(Dense(units=101, activation='softmax',name='04_softmax'))
